"""
URL configuration for seacarrias project.
...
from rest_framework_simplejwt.views import (
    TokenObtainPairView,  # Para obter tokens (login)
    TokenRefreshView,     # Para atualizar tokens
...
urlpatterns = [
    ...
    path("api/v1/avalie/", include("avaliacao.urls"))
]
